/** 
* Template of Functionality for annoying site:
* ******************************************
* Template that can add feature in the init() function and initParent() and initChild()
* Features Include:
* 	1. Creating Parent and Child Windows
*	2. Hiding cursors in both the parent and child windows
*	3. Block the back button on the parent page
*	4. Attempt to takeover the referrer Window from the user
*	5. Detects and denies the user from using shortcuts or clicks to close child windows
