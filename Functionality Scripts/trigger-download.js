/** 
* Trigger Multiple Downloads into Users file system:
* ******************************************
* Template that can add feature in the init() function and initParent() and initChild()
* Features Include:
* 	1. Creating Parent and Child Windows
*   2. Triggers download of multiple files from the FILE_DOWNLOADS array
*     1. Need to host the files for download or host an example website with files for download
...
// This needs to be changed with urls of files that are hosted or put the related files
// In your local directory on the server
// Need to change - files have been included in the directory for testing.
...
function init() {
    ...
    // Request for user mic and video -- Do not use unless needed
    // else {
